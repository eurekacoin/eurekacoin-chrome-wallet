export enum TARGET_NAME {
  INPAGE = 'eurekalite-inpage',
  CONTENTSCRIPT = 'eurekalite-contentscript',
  BACKGROUND = 'eurekalite-background',
}

export enum PORT_NAME {
  POPUP = 'eurekalite-popup',
  CONTENTSCRIPT = 'eurekalite-contentscript',
}
...
export enum API_TYPE {
  ...
  GET_INPAGE_EUREKALITE_ACCOUNT_VALUES = 'GET_INPAGE_EUREKALITE_ACCOUNT_VALUES',
  SEND_INPAGE_EUREKALITE_ACCOUNT_VALUES = 'EUREKALITE_ACCOUNT_CHANGED',
  CONNECT_INPAGE_EUREKALITE = 'CONNECT_EUREKALITE',
...
export enum MESSAGE_TYPE {
  ...
  GET_MAX_EUREKACOIN_SEND = 'GET_MAX_EUREKACOIN_SEND',
  GET_MAX_EUREKACOIN_SEND_RETURN = 'GET_MAX_EUREKACOIN_SEND_RETURN',
  GET_EUREKACOIN_USD = 'GET_EUREKACOIN_USD',
  GET_EUREKACOIN_USD_RETURN = 'GET_EUREKACOIN_USD_RETURN',
  ...
  GET_INPAGE_EUREKALITE_ACCOUNT_VALUES = 'GET_INPAGE_EUREKALITE_ACCOUNT_VALUES',
  SEND_INPAGE_EUREKALITE_ACCOUNT_VALUES = 'SEND_INPAGE_EUREKALITE_ACCOUNT_VALUES',
}
...
export enum EUREKALITE_ACCOUNT_CHANGE {
  LOGIN = 'Account Logged In',
  LOGOUT = 'Account Logged Out',
  BALANCE_CHANGE = 'EUREKACOIN Account Balance Changed',
