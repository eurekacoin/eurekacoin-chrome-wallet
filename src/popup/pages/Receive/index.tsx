...
class Receive extends Component<WithStyles & IProps, {}> {
  public render() {
    ...
    const { loggedInAccountName, info, eurekacoinBalanceUSD, networkBalAnnotation } = this.props.store.sessionStore;
      ...
      <div className={classes.root}>
        ...
        <div className={classes.contentContainer}>
          ...
          <div className={classes.amountContainer}>
            ...
            <Typography className={classes.token}>EUREKACOIN</Typography>
          </div>
          <Typography className={classes.currencyValue}>{`${eurekacoinBalanceUSD} ${networkBalAnnotation}`}</Typography>
